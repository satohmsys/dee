...
$rm_send_address[] = 'satohmsys@gmail.com';
...
//【任意】 自分に届くメールの題名
$rm_send_subject = '[コーポレートサイト]メールフォームからお問い合わせがありました。';
...
[コーポレートサイト]メールフォームからお問い合わせがありました。
お問い合わせの内容は以下の通りです。
...
$rm_send_name = 'Dee design';




//【任意】 相手に届く自動返信メールの題名
$rm_thanks_subject = '[Dee]お問い合わせいただき、ありがとうございました。';
...
3営業日ほどを目安に、折り返しご連絡いたしますので、しばらくお待ちください。
万が一返信がない場合は、大変恐れ入りますが、その旨を添えた上で再度ご連絡くださいませ。
...
この度はお問い合わせをいただき、重ねてお礼申し上げます。
-----------------------------------------------------------------------------------

　　Dee design
　　Web Site URL : https://dee.jpn.org
